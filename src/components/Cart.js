...
function countClickCart(e, name) {}
function countChangeCart(e, name) {}

function removeCartItem(e, name) {}
    ...
    >
      ...
      <div className="flex text-white bg-[#704F4F] border-t-2 border-black items-center flex-grow-0 flex-wrap justify-between flex-1">
        ...
        <div className="flex-1 flex justify-center items-center gap-2  ">
          {" "}
          <button
            onClick={(e) => countClickCart(e, h.name)}
            className="bg-gray-200  font-serif w-[30px] h-[80%] text-black text-lg"
          >
            -
          </button>{" "}
          <input
            onChange={(e) => countChangeCart(e, h.name)}
            value={h.itemCount}
            type="number"
        ...
        <button
          onClick={(e) => removeCartItem(e, h.name)}
          className="bg-red-400 px-1 font-sans"
        >
          Remove
        </button>
      </div>
